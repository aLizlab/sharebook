<template>
  <PageBase
    ...
    :github="github"
    :side-list="sideList"
    class="page-books-roomSlug-shelfSlug-bookSlug-sectionSlug-pageSlug"
  />
</template>
...
export default Vue.extend({
  data(): {
    ...
    return {
      ...
      sectionSlug: `books/${this.$route.params.roomSlug}/${this.$route.params.shelfSlug}/${this.$route.params.bookSlug}/${this.$route.params.sectionSlug}`,
      baseSlug: `books/${this.$route.params.roomSlug}/${this.$route.params.shelfSlug}/${this.$route.params.bookSlug}/${this.$route.params.sectionSlug}/${this.$route.params.pageSlug}`,
      page: undefined,
      sideList: [],
    }
  },
  async created() {
    ...
    this.page = _pageList.find(
      (page) => page.slug === this.$route.params.pageSlug
    )
...
.page-books-roomSlug-shelfSlug-bookSlug-sectionSlug-pageSlug {
}
</style>
